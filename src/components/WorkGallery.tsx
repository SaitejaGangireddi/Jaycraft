      ...
      <div className="max-w-7xl mx-auto space-y-10">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-orange/15 border border-brand-orange/30 text-[10px] font-bold uppercase tracking-widest text-brand-orange">
            ...
            <span>Factory & On-Site Portfolio</span>
          </div>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
            Our Executed Work
          </h2>
          <p className="text-xs sm:text-sm text-steel-muted leading-relaxed">
            Real spaces designed, manufactured in our facility, and executed turnkey.
          </p>
        </div>

        {loading ? (
          <div className="flex justify-center items-center py-20 text-steel-muted text-xs">
            <span className="w-2 h-2 bg-brand-orange rounded-full animate-ping mr-2" />
            Loading Jaycraft portfolio...
          </div>
        ) : images.length === 0 ? (
            ...
            {images.map((src, idx) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-3 sm:p-4">
                  <a
                    href="https://wa.me/919676427377?text=Hi%20Jaycraft,%20I'm%20inquiring%20about%20a%20design%20from%20your%20recent%20work."
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full py-2 rounded-xl bg-brand-orange text-white text-[11px] font-bold uppercase tracking-wider text-center flex items-center justify-center gap-1.5 shadow-md hover:bg-brand-orange-hover"
                  >
