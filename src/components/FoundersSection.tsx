    ...
    <section id="founder" className="py-16 bg-steel-deep px-4 flex justify-center items-center">
      <div className="w-full max-w-[460px] aspect-square rounded-3xl bg-steel-card/85 border border-steel-border/90 p-8 backdrop-blur-xl shadow-2xl flex flex-col items-center justify-between text-center relative overflow-hidden group hover:border-brand-orange/40 transition-colors">
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <div className="relative">
            <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-brand-orange shadow-lg p-0.5">
              <img
                src="https://res.cloudinary.com/dmkjnuolr/image/upload/v1788925159/file_00000000b96c821198750aff5034ebdb_gbdnge.png"
                alt="Ganesh Suthar"
        ...
        <a
          ...
          className="w-full py-3 rounded-full bg-steel-deep hover:bg-brand-orange border border-steel-border hover:border-brand-orange text-white text-xs font-bold tracking-wider uppercase transition-all flex items-center justify-center gap-2 shadow-md"
        >
